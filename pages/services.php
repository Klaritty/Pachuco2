<section id='servicios' class='py-[5rem] bg-[#000]'>
    <h1 class='text-[#fff] font-semibold font-Montse text-[30px] md:text-[40px] text-center'>
        Nuestros Pasos de Baile
    </h1>
    <h3 class="text-[#fff] font-normal font-Montse text-center mb-[1rem]">Servicios</h3>
    <div class="lg:max-w-[1020px] grid grid-cols-1 lg:grid-cols-4 lg:grid-rows-1 gap-8 lg:container lg:mx-auto">
