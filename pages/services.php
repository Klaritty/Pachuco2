<section id='servicios' class='py-[5rem] bg-[#000]'>
    <h1 class='text-[#fff] font-semibold font-Montse  text-[30px] md:text-[60px]  text-center'>
        Nuestros Pasos de Baile
    </h1>
    <h3 class="text-[#fff] font-semibold font-Montse text-center">Servicios</h3>
    <div class="lg:max-w-[1020px] grid grid-cols-2 lg:grid-cols-4 lg:grid-rows-1 gap-8 lg:container lg:mx-auto">
        ...
        <div class="relative lg:card flex justify-center flex-col items-center md:py-0 lg:py-0">
            ...
            <div class='absolute left-0 right-0 p-4 mt-[12rem] bg-opacity-60 bg-black text-left'>
