<section id='inicio' class='bg-white relative flex items-center justify-center'>
  ...
  <div class='pb-[5rem] container mx-auto relative z-20'>
    <div>
      <h1 class='text-center font-bold pb-[1rem] pt-[1rem] lg:pt-[5rem] font-Montse text-[30px] md:text-[35px] mx-auto w-[90%] mp:w-[70%] text-[#541388] uppercase'>Hemos compartido la pista de baile con ellos.</h1>
    </div>
